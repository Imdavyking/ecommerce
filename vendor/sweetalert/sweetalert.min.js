    ...
    (o.m = n =
      [
        ...
        function (t, n, e) {
          ...
          Object.defineProperty(n, "__esModule", { value: !0 }), o(e(25));
          var r = e(26);
        ...
        function (t, o, e) {
            ...
            var n = (function (t) {
              switch (t) {
                ...
                default:
                  ...
                  return Object.assign({}, i, { text: e, value: t });
              }
            })(t);
            return !0 === e
          ...
          function n(t) {
            ...
            switch (t.length) {
              case 1:
                e[o.CANCEL_KEY] = Object.assign({}, s, { visible: !1 });
                break;
              case 2:
                (e[o.CANCEL_KEY] = c(o.CANCEL_KEY, t[0])),
                  (e[o.CONFIRM_KEY] = c(o.CONFIRM_KEY, t[1]));
                break;
              default:
                r.throwErr(
          ...
          o.getButtonListOpts = function (t) {
            var e = o.defaultButtonList;
            return (
              "string" == typeof t
                ? (e[o.CONFIRM_KEY] = c(o.CONFIRM_KEY, t))
                : Array.isArray(t)
                ? (e = n(t))
                : r.isPlainObject(t)
                ? (e = (function (t) {
                ...
                : !1 === t
                ? (e = n([!1, !1]))
                : void 0 === t && (e = o.defaultButtonList),
              e
            );
          };
        },
        ...
        function (t, e, n) {
          ...
          (e.onAction = function (t) {
            ...
            var e,
              n = u.default.actions[t],
              o = n.value;
            !1 === n.closeModal
              ? ((e = c + "--" + t), r.getNode(e).classList.add(l))
              : (r.getNode(a).classList.remove(s), (u.default.isOpen = !1)),
              u.default.promise.resolve(o);
          }),
            (e.getState = function () {
        ...
        function (t, e, n) {
          ...
          function d(t) {
            ...
            null !== t.parentNode &&
              ...
              0 <= (e = v.indexOf(t)) && v.splice(e, 1));
          }
          function f(t) {
            var e = document.createElement("style");
            return (t.attrs.type = "text/css"), p(e, t.attrs), u(t, e), e;
          }
          function p(e, n) {
              ...
              (a = t.singleton
                ...
                ? ((s = t),
                  ...
                  (i = function (t, e, n) {
                    ...
                    (e.convertToAbsoluteUrls || i) && (o = w(o)),
                      r && (o += "\n");
          ...
          function m(t, e, n, o) {
            var r,
              ...
              a = n ? "" : o.css;
            t.styleSheet
              ? (t.styleSheet.cssText = x(e, a))
              : ((r = document.createTextNode(a)),
                (i = t.childNodes)[e] && t.removeChild(i[e]),
                i.length ? t.insertBefore(r, i[e]) : t.appendChild(r));
          }
          var o,
            r,
            b = {},
          ...
          t.exports = function (t, a) {
            ...
            ((a = a || {}).attrs = "object" == _typeof(a.attrs) ? a.attrs : {}),
              a.singleton || (a.singleton = i()),
                ...
                value: function (t, e) {
                  ...
                  for (
                    var r,
                      i,
                      a = 0 | e,
                      s = Math.max(0 <= a ? a : o - Math.abs(a), 0);
                    s < o;
          ...
          (function (e) {
            ...
            (t = this),
              ...
              (i.resolve = function (e) {
                return e && "object" == _typeof(e) && e.constructor === i
                  ? e
                  : new i(function (t) {
                      t(e);
                    });
        ...
        function (t, e, n) {
          (function (t, m) {
            !(function (n, o) {
              ...
              var a, s, c, l, u, t, d, e, f;
              function p(t) {
                t.source === n &&
                  "string" == typeof t.data &&
                  0 === t.data.indexOf(f) &&
                  i(+t.data.slice(f.length));
              }
              n.setImmediate ||
                ((s = 1),
                (l = !(c = {})),
                ...
                (a =
                  "[object process]" === {}.toString.call(n.process)
                    ...
                    : u && "onreadystahouseange" in u.createElement("script")
                    ? ((d = u.documentElement),
                      function (t) {
                        var e = u.createElement("script");
                        (e.onreadystahouseange = function () {
                          i(t),
                            (e.onreadystahouseange = null),
                            d.removeChild(e),
                            (e = null);
                        }),
                          d.appendChild(e);
        ...
        function (t, e, n) {
          ...
          var r = n(24),
            ...
            s = n(36);
          (o.close = i.onAction),
            (o.getState = i.getState),
            (o.setActionValue = a.setActionValue),
            (o.stopLoading = i.stopLoading),
            (o.setDefaults = s.setDefaults),
            (e.default = o);
        },
        function (t, e, n) {
          "use strict";
        ...
        function (t, e, n) {
          ...
          e.default = function (t) {
            var e;
            t &&
              ((e = o.injectElIntoModal(r.iconMarkup)),
              (c.includes(t)
                ? function (t, e) {
                    var n = a + "--" + t;
                    e.classList.add(n);
        ...
        function (t, e, n) {
          ...
          (e.initTitle = function (t) {
            var e;
            t &&
              (((e = a.injectElIntoModal(i.titleMarkup)).textContent = t),
              r(e));
          }),
            (e.initText = function (t) {
              ...
              t &&
                ...
                (e = a.injectElIntoModal(i.textMarkup)).appendChild(o),
                r(e));
            });
        },
        function (t, e, n) {
              ...
              var r = t[o],
                i = (function (t, e, n) {
                  var o = e.text,
                    ...
                    i = e.className,
                    a = e.closeModal,
                    s = d.stringToNode(b.buttonMarkup),
                    c = s.querySelector("." + f),
                    l = f + "--" + t;
                  c.classList.add(l),
                    i &&
                    ...
                    n && t === m.CONFIRM_KEY && c.classList.add(p),
                    (c.textContent = o);
                  var u = {};
                  return (
                    (u[t] = r),
                    h.setActionValue(u),
                    h.setActionOptionsFor(t, { closeModal: a }),
        ...
        function (t, e, n) {
          ...
          function r(t, e, n) {
            ...
            "input" === e &&
              ((o = r).addEventListener("input", function (t) {
          ...
          e.default = function (t) {
            var e, n, o;
            t &&
              ((e = i.injectElIntoModal(a.contentMarkup)),
              (n = t.element),
              (o = t.attributes),
              "string" == typeof n ? r(e, n, o) : e.appendChild(n));
          };
        },
        function (t, e, n) {
          "use strict";
        ...
        function (t, e, n) {
          ...
          function o(t) {
            if (c.default.isOpen)
              switch (t.key) {
                case "Tab":
                  return t.preventDefault(), void g();
              }
          }
          function i(t) {
            if (c.default.isOpen)
              return "Tab" === t.key && t.shiftKey
                ? (t.preventDefault(), void h())
                : void 0;
          }
          function a() {
            var t,
              e = u.getNode(p).querySelectorAll("." + m);
            e.length &&
              ((t = e)[t.length - 1].addEventListener("keydown", o),
              e[0].addEventListener("keydown", i));
          }
          function s(t) {
            if (u.getNode(b) === t.target) return l.onAction(d.CANCEL_KEY);
          }
          var c = n(5),
            l = n(6),
            u = n(1),
            ...
            h = function () {
              var t = u.getNode(p).querySelectorAll("." + m),
                e = t[t.length - 1];
              e && e.focus();
            };
          e.default = function (t) {
            ...
            t.closeOnEsc
              ...
              (o = u.getNode(b)).removeEventListener("click", s),
              n && o.addEventListener("click", s),
              (e = t.timer),
              c.default.timer && clearTimeout(c.default.timer),
              e &&
                (c.default.timer = window.setTimeout(function () {
                  return l.onAction(d.CANCEL_KEY);
                }, e));
          };
        },
        function (t, e, n) {
          ...
          function b(t, e) {
            c.throwErr(m(e) + " argument ('" + t + "') is invalid");
          }
          function g(t, e) {
            var n = t + 1,
              o = e[n];
          ...
          function h(t, e, n, o) {
            ...
            if ("string" === a) {
              ...
              if (2 === n) return g(n, o), { icon: e };
              b(e, n);
            } else {
              if (s && 0 === n) return g(n, o), { content: e };
              if (c.isPlainObject(e))
                return (
                  void 0 !== (i = o[(r = n + 1)]) &&
                    c.throwErr("Unexpected " + m(r) + " argument (" + i + ")"),
                  e
                );
              b(e, n);
            }
          ...
          e.getOpts = function () {
            ...
            var e,
              ...
              a =
                ...
                void 0 !== n &&
                  void 0 !== i &&
                  c.throwErr("Cannot set both 'button' and 'buttons' options!"),
                void 0 !== n ? { confirm: n } : i);
            (r.buttons = l.getButtonListOpts(a)),
              delete r.button,
              (r.content = u.getContentOpts(r.content));
